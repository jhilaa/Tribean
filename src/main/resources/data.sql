insert into tag (tag_name, color) values ('php', 'black');
insert into tag (tag_name, color) values ('js', 'red');
insert into tag (tag_name, color) values ('regex', 'blue');
insert into tag (tag_name, color) values ('python', 'pink');
insert into tag (tag_name, color) values ('node', 'green');
--
