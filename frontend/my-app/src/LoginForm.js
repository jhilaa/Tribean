...
export function LoginForm({setUserConnectedInfoLogin}) {
    ...
    const onSubmit = ((e) => {
        ...
        login(email, password)
            .then(axios.post("/authenticate", {email, password}))
            .then(response => {
    ...
    const title = "LoginForm incorrect"
    const bodyTxt = "LoginForm ou mot de passe incorrect"
    return (<>
...
export default function Wrapper(props) {
    const history = useNavigate();
    return <LoginForm {...props} history={history}/>;
}